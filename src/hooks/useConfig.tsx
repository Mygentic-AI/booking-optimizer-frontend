...
const defaultConfig: AppConfig = {
  ...
  description: "Mygentic AI is now accepting candidates for its Personal Agent Beta. Speak with Elvie to go through the process and kick the tires on our agent",
  video_fit: "cover",
  settings: {
    editable: false,
    theme_color: "pink",
    ...
    ws_url: "",  // Remove the hardcoded ws_url
    token: "",   // Remove the hardcoded token
  },
  show_qr: false,
}
  ...
  const setUrlSettings = useCallback(
    (us: UserSettings) => {
      const obj = new URLSearchParams({
        ...
        theme_color: us.theme_color || "pink",
      });
